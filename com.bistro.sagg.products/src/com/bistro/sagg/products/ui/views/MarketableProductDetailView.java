...
public class MarketableProductDetailView extends ViewPart {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "com.bistro.sagg.products.ui.views.MarketableProductDetailView";
	...
	public MarketableProductDetailView() {
		super();
		this.bundleContext = FrameworkUtil.getBundle(MarketableProductDetailView.class).getBundleContext();
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				MarketableProductDetailView.this.fillContextMenu(manager);
			}
		});
	}
